...
function DashboardMainPage() {
  ...
  useEffect(() => {
    ...
    covidStatsService.getActiveCase().then((result) => {
      setActiveCase(result.data);
    });

    covidStatsService.getTotalCase().then((result) => {
      setTotalCase(result.data);
    });
    covidStatsService.getTurkeyCase().then((result) => {
      var caseArray = result.data.Countries.filter(function (country) {
        return country.Country === "Turkey";
      });
      setTurkeyTotalCase(caseArray[0].TotalConfirmed);
      setTurkeyActiveCase(caseArray[0].NewConfirmed);
      setTurkeyRecoveredCase(caseArray[0].NewRecovered);
      setTurkeyDeathCase(caseArray[0].NewDeaths);
    });
    ...
    currentDateService =
      ...
      "/" +
      (currentDateService.getMonth() + 1) +
      "/" +
      currentDateService.getFullYear();
        ...
        <div className="cardsWrap">
          <div className="wrapHeader">
            ...
            <h3>
              ...
              <Link className="link" to="/" onClick={removeStorage}>
                Logout
              </Link>
            </h3>
          </div>
            ...
            <div className="card7">
              ...
              <ul>
                ...
                <li>
                  ...
                  Recovered: {totalCase - activeCase}
                </li>
                <li>
        ...
        <div className="card3">
          <div className="row3">
            <div className="card4">
              ...
              <p>Show that you care. Wear.</p>
            </div>
          </div>
          <div className="row3">
            <div className="card5">
              <p>
                Feeling a little under the weather ?<br />
                <span> Take Test</span>
              </p>
